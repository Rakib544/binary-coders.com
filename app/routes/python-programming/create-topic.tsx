...
export const action: ActionFunction = async ({ request }) => {
  try {
    ...
    const res = await createTopic(title as string, JSON.parse(html as string))
...
export const meta: MetaFunction = () => {
  return {
    title: 'New Topic - Binary Coders',
    description:
      'Write new topic based on python programming fundamentals to user new programmers to understand the basic concepts',
  }
}
